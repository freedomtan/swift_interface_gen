...
swiftc -parse-as-library main.swift Parser.swift Model.swift Config.swift String+RegexFree.swift TreeNode.swift GenerateStubs.swift SelfAlign.swift PostProcess/*.swift DemangleWrapper.o -lc++ -o ../../../swift-interface-gen
cd ../../../
```
